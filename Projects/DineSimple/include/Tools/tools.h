...
/****************************************************************************************************************************************************************
 * @name: hexToRGB
 * @brief: 将十六进制颜色值拆解为 RGB 分量，并组合成 24 位颜色值
 * @param {uint32_t} hexColor - 十六进制颜色值，例如 0xFF00FF
 * @return: 组合后的 24 位颜色值
 * @date: 2024-08-17
 * @version: 1.0
 * @note: 使用 getColor24 宏组合 RGB 分量
 *****************************************************************************************************************************************************************/
#define hexToRGB(hexColor)                                                     \
  (getColor24((((u32)hexColor >> 16) & 0xff), (((u32)hexColor >> 8) & 0xff),   \
              ((u32)hexColor & 0xff)))
